...
export const TEMPLES = [
  {
    ...
    trustBadge: { trustName: "Shri Kashi Vishwanath Temple Trust", trustType: "Government Trust", verificationUrl: "https://shrikashivishwanath.org", verified: true },
    guidedDarshanAvailable: true,
    guidedDarshanTiers: [
      { id: "gd-self", tier: "Self-Guided", price: 0, desc: "Digital info pack with temple map, timings & tips" },
      { id: "gd-accompanied", tier: "Accompanied", price: 1501, desc: "Local Pandit Ji walks with you through the temple complex" },
      { id: "gd-vip", tier: "VIP Priority", price: 3501, desc: "Skip-queue entry + dedicated Pandit + special sanctum darshan" },
    ],
  },
  {
    ...
    hasPrasadDelivery: true,
    has80GExemption: true,
    trustBadge: { trustName: "Mahakaleshwar Temple Management Committee", trustType: "Government Trust", verificationUrl: "https://mahakaleshwar.nic.in", verified: true },
    guidedDarshanAvailable: true,
    guidedDarshanTiers: [
      { id: "gd-self-mk", tier: "Self-Guided", price: 0, desc: "Digital info pack with Bhasma Aarti schedule" },
      { id: "gd-accompanied-mk", tier: "Accompanied", price: 1801, desc: "Local priest guides you through all 3 shrines" },
      { id: "gd-vip-mk", tier: "VIP Priority", price: 4001, desc: "Priority Bhasma Aarti entry + dedicated guide" },
    ],
  },
  {
    id: "kedarnath-dham",
    ...
    hasPrasadDelivery: true,
    has80GExemption: true,
    trustBadge: { trustName: "Shri Badrinath-Kedarnath Temple Committee (BKTC)", trustType: "Shrine Board", verificationUrl: "https://badrinath-kedarnath.gov.in", verified: true },
    guidedDarshanAvailable: true,
    guidedDarshanTiers: [
      { id: "gd-self-kd", tier: "Self-Guided", price: 0, desc: "Trek route guide + temple timings" },
      { id: "gd-accompanied-kd", tier: "Accompanied", price: 2501, desc: "Local guide from Gaurikund to sanctum + assistance" },
      { id: "gd-vip-kd", tier: "VIP Priority", price: 5001, desc: "Helicopter + priority darshan + dedicated pandit" },
    ],
  },
  {
    ...
    hasPrasadDelivery: true,
    has80GExemption: true,
    trustBadge: { trustName: "Shri Ram Janmabhoomi Teerth Kshetra Trust", trustType: "Central Government Trust", verificationUrl: "https://srjbtkshetra.org", verified: true },
    guidedDarshanAvailable: true,
    guidedDarshanTiers: [
      { id: "gd-self-ay", tier: "Self-Guided", price: 0, desc: "Temple layout guide + aarti schedule" },
      { id: "gd-accompanied-ay", tier: "Accompanied", price: 1101, desc: "Pandit Ji accompanies through Ram Parikrama" },
      { id: "gd-vip-ay", tier: "VIP Priority", price: 2501, desc: "Fast-track darshan + dedicated pandit + special bhog" },
    ],
  },
  {
    id: "tirupati-balaji",
    ...
    hasPrasadDelivery: true,
    has80GExemption: true,
    trustBadge: { trustName: "Tirumala Tirupati Devasthanams (TTD)", trustType: "Statutory Body", verificationUrl: "https://www.tirumala.org", verified: true },
    guidedDarshanAvailable: true,
    guidedDarshanTiers: [
      { id: "gd-self-tp", tier: "Self-Guided", price: 0, desc: "Seven Hills walking route + darshan slot info" },
      { id: "gd-accompanied-tp", tier: "Accompanied", price: 2001, desc: "TTD-approved guide through Tirumala complex" },
      { id: "gd-vip-tp", tier: "VIP Priority", price: 5501, desc: "Special entry darshan + dedicated priest + Laddu prasadam" },
    ],
  },
  {
    id: "kamakhya-devi",
    ...
    hasPrasadDelivery: true,
    has80GExemption: true,
    trustBadge: { trustName: "Kamakhya Devalaya Board", trustType: "State Temple Board", verificationUrl: "https://kamakhyatemple.org", verified: true },
    guidedDarshanAvailable: true,
    guidedDarshanTiers: [
      { id: "gd-self-km", tier: "Self-Guided", price: 0, desc: "Nilachal Hill route guide + puja timings" },
      { id: "gd-accompanied-km", tier: "Accompanied", price: 1501, desc: "Tantric priest guides through the Yoni shrine complex" },
      { id: "gd-vip-km", tier: "VIP Priority", price: 3001, desc: "Priority entry + dedicated Doloi + special Sindoor blessing" },
    ],
  }
];
...
export const YATRA_PACKAGES = [
  {
    id: "yatra-char-dham",
    title: "Char Dham Yatra",
    subtitle: "Yamunotri → Gangotri → Kedarnath → Badrinath",
    duration: "12 Days / 11 Nights",
    temples: ["Yamunotri", "Gangotri", "Kedarnath Dham", "Badrinath Dham"],
    templeCount: 4,
    price: 28999,
    originalPrice: 38500,
    perPerson: true,
    transport: "AC Volvo + Helicopter Option",
    highlights: ["Helicopter ride to Kedarnath", "All meals included", "Certified Pandit at each temple", "Prasad delivery to home"],
    image: "/images/kedarnath.jpg",
    badge: "Most Popular",
    rating: 4.97,
    reviewCount: 3200,
    nextDeparture: "15 Sept 2026",
    slotsLeft: 8,
  },
  {
    id: "yatra-jyotirlinga-5",
    title: "Panch Jyotirlinga Circuit",
    subtitle: "Kashi → Ujjain → Omkareshwar → Trimbakeshwar → Somnath",
    duration: "10 Days / 9 Nights",
    temples: ["Kashi Vishwanath", "Mahakaleshwar", "Omkareshwar", "Trimbakeshwar", "Somnath"],
    templeCount: 5,
    price: 24500,
    originalPrice: 32000,
    perPerson: true,
    transport: "AC Train + Private Vehicle",
    highlights: ["Bhasma Aarti at Mahakaleshwar", "Ganga Aarti at Varanasi", "All pujas pre-booked", "Group of max 20 devotees"],
    image: "/images/mahakaleshwar.jpg",
    badge: "New",
    rating: 4.95,
    reviewCount: 890,
    nextDeparture: "22 Sept 2026",
    slotsLeft: 12,
  },
  {
    id: "yatra-shakti-peeth",
    title: "Shakti Peeth Pilgrimage",
    subtitle: "Kamakhya → Kalighat → Vindhyavasini → Vaishno Devi",
    duration: "8 Days / 7 Nights",
    temples: ["Kamakhya Devi", "Kalighat", "Vindhyavasini", "Vaishno Devi"],
    templeCount: 4,
    price: 22000,
    originalPrice: 29000,
    perPerson: true,
    transport: "Flight + AC Vehicle",
    highlights: ["Helicopter to Vaishno Devi", "Special Sindoor puja at Kamakhya", "Women-friendly amenities", "Dedicated female guide option"],
    image: "/images/kamakhya_devi.jpg",
    badge: "Limited Slots",
    rating: 4.93,
    reviewCount: 670,
...
export const SANATAN_WALL_POSTS = [
  {
    id: "sw-1",
    author: "Priya Sharma",
    avatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=120&q=80",
    city: "Delhi",
    templeName: "Shri Kashi Vishwanath",
    content: "Just received the prasad from our family's Rudrabhishek. The Bhasma and Rudraksha feel truly blessed. Our entire family performed the sankalpa together on video call! 🙏",
    image: "/images/puja_rudrabhishek.jpg",
    likes: 342,
    timeAgo: "2 hours ago",
  ...
  },
  {
    ...
    templeName: "Tirumala Balaji",
    content: "Being 8,000 miles away from India, I never thought I could offer chadhava at Tirupati. The Laddu arrived in perfect vacuum-sealed packaging within 5 days! Technology bridging faith. 🛕",
    image: "/images/tirupati_balaji.jpg",
    likes: 518,
    timeAgo: "5 hours ago",
    category: "Photos",
  ...
  },
  {
    ...
    city: "Bengaluru",
    templeName: "Maa Kamakhya",
    content: "The guided darshan experience at Kamakhya was life-changing. Our pandit explained the significance of every shrine. Worth every rupee for the VIP package! 🌺",
    image: "/images/kamakhya_devi.jpg",
    likes: 289,
    timeAgo: "1 day ago",
    category: "Temple Reviews",
    verified: true,
  },
  {
    id: "sw-4",
    ...
    city: "Mumbai",
    templeName: "Ram Janmabhoomi, Ayodhya",
    content: "Took our 80-year-old grandmother on the virtual darshan. She had tears of joy seeing Ram Lalla. The peetambar vastra chadhava video was crystal clear. Thank you Shiri Mandir! 🏹",
    image: "/images/ayodhya_ram_mandir.jpg",
    likes: 891,
    timeAgo: "2 days ago",
    category: "Experiences",
  ...
  },
  {
    ...
    city: "Jaipur",
    templeName: "Mahakaleshwar, Ujjain",
    content: "The Bhasma Aarti live stream quality was incredible. Could hear every mantra clearly even at 4 AM. The 80G receipt was generated instantly — perfect for tax filing! 📜",
    image: "/images/mahakaleshwar.jpg",
    likes: 456,
    timeAgo: "3 days ago",
    category: "Experiences",
  ...
  },
  {
    ...
    city: "London, UK",
    templeName: "Kedarnath Dham",
    content: "Couldn't travel to Kedarnath due to work, but the Akhand Diya seva was performed beautifully. Watching the Himalayan snow peaks during the live stream was surreal! ❄️🔱",
    image: "/images/kedarnath.jpg",
    likes: 634,
    timeAgo: "4 days ago",
    category: "Photos",
...
export const REFERRAL_PROGRAM = {
  ...
  currency: "₹",
  maxReferrals: 50,
  totalReferrals: 12400,
  totalDevoteesJoined: 8200,
  shareMessage: "Join Shiri Mandir and get ₹150 off your first puja booking! India's most trusted temple devotion platform with verified temple trusts and live darshan queue.",
};

export const GOTRA_LIST = [
  "Kashyap", "Bharadwaj", "Vashishtha", "Vishwamitra", "Gautam", "Jamadagni",
  "Atri", "Agastya", "Angiras", "Pulastya", "Kratu", "Pulaha", "Marichi",
  "Daksha", "Bhrigu", "Shandilya", "Kaundinya", "Mudgala", "Parashar",
  "Garg", "Maudgalya", "Sandipani", "Vatsa", "Upamanyu", "Shaunaka",
  "Harita", "Kaushik", "Dhananjaya", "Mandavya", "Kanva",
];

export const PUJA_RECOMMENDATIONS = [
  { event: "Marriage Anniversary", pujaIds: ["puja-sudarshana-homa"], message: "Celebrate with Lakshmi-Narayana Seva for continued marital bliss" },
  { event: "New Business Launch", pujaIds: ["puja-sudarshana-homa", "puja-baglamukhi-shatru"], message: "Invoke Lord Ganesha & Lakshmi for prosperity and obstacle removal" },
  { event: "Health Recovery", pujaIds: ["puja-mahashivratri-rudra"], message: "Maha Rudrabhishek is considered most potent for health and longevity" },
  { event: "Exam / Competition", pujaIds: ["puja-baglamukhi-shatru"], message: "Maa Baglamukhi grants victory over challenges and competition" },
  { event: "Ancestral Peace", pujaIds: ["puja-kaal-sarp-shanti"], message: "Navagraha shanti soothes ancestral afflictions and karmic debt" },
  { event: "Child's Birth", pujaIds: ["puja-mahashivratri-rudra", "puja-sudarshana-homa"], message: "Welcome the newborn with divine blessings from Shiva and Vishnu" },
];
